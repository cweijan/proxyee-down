  ...
  public ResponseEntity resolve(HttpServletRequest request) throws Exception {
    ...
    try {
      ...
      try {
        ...
        HttpRequestForm rquestVo = HttpRequestForm.parse(httpRequestInfo);
        rquestVo.setUrl(requestForm.getUrl());
        ResolveForm resolveForm = new ResolveForm(rquestVo, httpResponseInfo);
